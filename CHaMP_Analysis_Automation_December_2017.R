...
# Change this from 1 to 2: force use to have at least three data points for trend
...
idx
paste(Data_Mean$SiteName, 2017)
pop.frame$Site_ID
pop.frame$Year
paste(pop.frame$Site_ID, pop.frame$Year)
...
tapply(Wen$LengthKM, factor(Wen$AStrat2017),sum)
